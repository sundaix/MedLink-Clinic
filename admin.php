<?php
// admin.php - IDENTICAL TO JS ADMIN BUT WITH PHP AUTH
session_start();
        ...
        <div class="collapse navbar-collapse" id="adminNav">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
             ...
             <li class="nav-item">
          <a href="https://medlinkclinic.wuaze.com/" class="btn btn-success btn-sm me-2" target="_blank">
          ...
          <div id="archiveSection" class="content-section d-none">
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <button class="btn btn-outline-primary btn-sm" onclick="smartCleanupAppointments()">
                  <i class="fas fa-broom me-1"></i> Smart Cleanup
                </button>
              </div>
              <div class="card-body">
